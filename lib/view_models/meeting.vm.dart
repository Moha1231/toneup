...
class MeetingViewModel extends MyBaseViewModel {
  ...
  shareNewMeeting() async {
    ...
    shareText +=
        "Join on android : https://play.google.com/store/apps/details?id=com.meet.recovery ";
    shareText += "Join on ios: Tone UP Application in App Store";
    shareText +=
        " Meeting ID : ${AppStrings.meetingPrefixID}${newMeetingIdTEC.text}";
